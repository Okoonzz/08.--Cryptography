...
extern "C" {
    __declspec(dllexport) bool signa(const char* pathprivkey, const char* pathdata, char* data, char* pathdatakeyb, const char* signatruepath, int choice, int choicepath);
}

bool signa(const char* pathprivkey, const char* pathdata, char* data, char* pathdatakeyb, const char* signatruepath, int choice, int choicepath) {
#ifdef _linux_
    ...
    case 1: { //file
        ...
        case 1: { //PEM
            ...
            std::ofstream signatureFile(signatruepath, std::ios::binary);
